    		...
    		while (!file.eof())
    		{
      		...
      		if (line.find("@") == string::npos && line.find("%") == string::npos && line.find("*") == string::npos) {
				...
				string keyword = e["KEYWORD"];
                                if (keyword.compare("DRIFT") == 0 || keyword.compare("OCTUPOLE") == 0 
				|| keyword.compare("QUADRUPOLE") == 0 || keyword.compare("SEXTUPOLE") == 0 
				|| keyword.compare("DECAPOLE") == 0 || keyword.compare("SBEND") == 0
                                || keyword.compare("MULTIPOLE") == 0)
