...
#########################
  ...
  def addBeamBeam(self, name, K, sigmax, sigmay, xm, ym, position = None, t = "ROUNDBB"):
    """
    Add a BEAMBEAM element to the twiss object - by default it adds at the end

    :param string name: NAME of the element
    :param int K: Strength of the element
    :param int sigmax: Sigma in X
    :param int sigmay: Sigma in Y
    :param int xm: offset of the element in X
    :param int ym: offset of the element in Y
    :param int position: Position of the element to be added in the line (by default it's at the end)
    :param string t: KEYWORD of the element (by default "ROUNDBB", you don't normally want to change this)
    """
